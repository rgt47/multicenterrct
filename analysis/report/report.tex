...
\renewcommand{\stamptime}{2026-08-15 16:33 PDT}
\renewcommand{\stampversion}{\detokenize{9c49deb}}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{booktabs}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={\label{fig:fig-power}Power (left) and coverage probability (right) across scenarios. Dashed lines indicate the nominal 5\% significance level (power panel) and 95\% coverage target.}]{report_files/report_files/figure-latex/fig-power-1.pdf}}
\caption{\label{fig:fig-power}Power (left) and coverage probability (right) across scenarios. Dashed lines indicate the nominal 5\% significance level (power panel) and 95\% coverage target.}
\end{figure}
